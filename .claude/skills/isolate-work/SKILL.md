...
**Called by:**
- `explore-idea` - When design is approved and implementation follows
- Any workflow needing isolated workspace

**Pairs with:**
- `finish-branch` - Cleanup after work complete
- `execute-plan` or `execute-with-agents` - Work happens in isolated workspace
