...
- Before searching the filesystem by name for any referenced skill (e.g. `feather:X`, `gsd-Y`, `foo:bar`) — always call search_skills first, in addition to any built-in Claude skills lookup.
